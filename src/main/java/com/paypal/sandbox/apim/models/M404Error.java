...
public class M404Error {
     ...
     * @param  name  Error404NameEnum value for name.
     * @param  message  Error404MessageEnum value for message.
     ...
     */
    public M404Error(
            Error404NameEnum name,
            Error404MessageEnum message,
     ...
     */
    @JsonSetter("name")
    public void setName(Error404NameEnum name) {
        this.name = name;
    }
    ...
    @JsonGetter("message")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Error404MessageEnum getMessage() {
        return message;
    }

    /**
     * Setter for Message.
     * @param message Value for Error404MessageEnum
     */
    @JsonSetter("message")
    public void setMessage(Error404MessageEnum message) {
        this.message = message;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder name(Error404NameEnum name) {
            this.name = name;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder message(Error404MessageEnum message) {
            this.message = message;
            return this;
        }

...
public class MERCHANTINITIATEDWITHAUTHENTICATIONRESULTS {
    ...
    private ErrorMerchantInitiatedWithAuthResultsAnd3dsEnum description;
     ...
     * @param  description  ErrorMerchantInitiatedWithAuthResultsAnd3dsEnum value for description.
     */
    public MERCHANTINITIATEDWITHAUTHENTICATIONRESULTS(
            MerchantInitiatedAuthenticationResultsEnum issue,
            ErrorMerchantInitiatedWithAuthResultsAnd3dsEnum description) {
        this.issue = issue;
     ...
     * @return Returns the ErrorMerchantInitiatedWithAuthResultsAnd3dsEnum
     */
    @JsonGetter("description")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ErrorMerchantInitiatedWithAuthResultsAnd3dsEnum getDescription() {
        return description;
    }

    /**
     * Setter for Description.
     * @param description Value for ErrorMerchantInitiatedWithAuthResultsAnd3dsEnum
     */
    @JsonSetter("description")
    public void setDescription(ErrorMerchantInitiatedWithAuthResultsAnd3dsEnum description) {
        this.description = description;
    }
    ...
    public static class Builder {
        ...
        /**
         * Setter for description.
         * @param  description  ErrorMerchantInitiatedWithAuthResultsAnd3dsEnum value for
         *         description.
         * @return Builder
         */
        public Builder description(ErrorMerchantInitiatedWithAuthResultsAnd3dsEnum description) {
            this.description = description;
            return this;
        }

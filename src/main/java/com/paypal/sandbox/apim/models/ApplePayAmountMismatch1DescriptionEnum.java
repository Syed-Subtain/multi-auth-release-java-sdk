...
/**
 * ApplePayAmountMismatch1DescriptionEnum to be used.
 */
public enum ApplePayAmountMismatch1DescriptionEnum {
    ...
    private static TreeMap<String, ApplePayAmountMismatch1DescriptionEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ApplePayAmountMismatch1DescriptionEnum constructFromString(String toConvert) throws IOException {
        ApplePayAmountMismatch1DescriptionEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static ApplePayAmountMismatch1DescriptionEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of ApplePayAmountMismatch1DescriptionEnum values to list of string values.
     * @param toConvert The list of ApplePayAmountMismatch1DescriptionEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ApplePayAmountMismatch1DescriptionEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ApplePayAmountMismatch1DescriptionEnum enumValue : toConvert) {

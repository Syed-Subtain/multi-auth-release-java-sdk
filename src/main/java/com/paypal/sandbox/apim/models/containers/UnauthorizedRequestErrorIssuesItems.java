 ...
 */
@JsonDeserialize(using = UnauthorizedRequestErrorIssuesItems.UnauthorizedRequestErrorIssuesItemsDeserializer.class)
public abstract class UnauthorizedRequestErrorIssuesItems {
     ...
     */
    public static UnauthorizedRequestErrorIssuesItems fromINVALIDACCOUNTSTATUS(
    ...
    private static class INVALIDACCOUNTSTATUSCase extends UnauthorizedRequestErrorIssuesItems {
    ...
    /**
     * This is a custom deserializer class for UnauthorizedRequestErrorIssuesItems.
     */
    protected static class UnauthorizedRequestErrorIssuesItemsDeserializer
            extends JsonDeserializer<UnauthorizedRequestErrorIssuesItems> {

        @Override
        public UnauthorizedRequestErrorIssuesItems deserialize(JsonParser jp, DeserializationContext ctxt)

...
public class Level3CardProcessingData {
    ...
    private PortableInternationalPostalAddress shippingAddress;
     ...
     * @param  shippingAddress  PortableInternationalPostalAddress value for shippingAddress.
    ...
    public Level3CardProcessingData(
            ...
            PortableInternationalPostalAddress shippingAddress,
     ...
     * Use this field to break down the shipping cost included in the total purchase amount. The
     ...
     * Use this field to break down the duty amount included in the total purchase amount. The value
     * provided here will not add to the total purchase amount. The value cannot be negative.
     * @return Returns the Money
     */
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public PortableInternationalPostalAddress getShippingAddress() {
     ...
     * `address_line_2`, `admin_area_1`, `admin_area_2`, `postal_code`, and `country_code`
     * properties.
     * @param shippingAddress Value for PortableInternationalPostalAddress
     */
    @JsonSetter("shipping_address")
    public void setShippingAddress(PortableInternationalPostalAddress shippingAddress) {
        this.shippingAddress = shippingAddress;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder shippingAddress(PortableInternationalPostalAddress shippingAddress) {
            this.shippingAddress = shippingAddress;
            return this;
        }

...
/**
 * This is a model class for OrderAllof1 type.
 */
public class OrderAllof1 {
    private String id;
    ...
    /**
     * Converts this OrderAllof1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OrderAllof1 [" + "id=" + id + ", paymentSource=" + paymentSource + ", intent="
    ...
    /**
     * Builds a new {@link OrderAllof1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link OrderAllof1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link OrderAllof1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link OrderAllof1} object using the set fields.
         * @return {@link OrderAllof1}
         */
        public OrderAllof1 build() {
            return new OrderAllof1(id, paymentSource, intent, processingInstruction, payer,

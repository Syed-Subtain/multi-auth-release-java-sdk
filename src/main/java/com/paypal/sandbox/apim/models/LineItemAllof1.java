...
/**
 * This is a model class for LineItemAllof1 type.
 */
public class LineItemAllof1 {
    ...
    /**
     * Converts this LineItemAllof1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "LineItemAllof1 [" + "commodityCode=" + commodityCode + ", discountAmount="
                + discountAmount + ", totalAmount=" + totalAmount + ", unitOfMeasure="
                + unitOfMeasure + "]";
    }

    /**
     * Builds a new {@link LineItemAllof1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link LineItemAllof1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link LineItemAllof1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link LineItemAllof1} object using the set fields.
         * @return {@link LineItemAllof1}
         */
        public LineItemAllof1 build() {
            return new LineItemAllof1(commodityCode, discountAmount, totalAmount, unitOfMeasure);
        }
    }
}

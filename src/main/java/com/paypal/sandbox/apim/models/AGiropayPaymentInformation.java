...
/**
 * This is a model class for AGiropayPaymentInformation type.
 */
public class AGiropayPaymentInformation {
    private String name;
     ...
     * Default constructor.
     */
    public AGiropayPaymentInformation() {
    }
    ...
    /**
     * Converts this AGiropayPaymentInformation into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AGiropayPaymentInformation [" + "name=" + name + ", countryCode=" + countryCode
                + ", experienceContext=" + experienceContext + "]";
    }

    /**
     * Builds a new {@link AGiropayPaymentInformation.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AGiropayPaymentInformation.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AGiropayPaymentInformation}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link AGiropayPaymentInformation} object using the set fields.
         * @return {@link AGiropayPaymentInformation}
         */
        public AGiropayPaymentInformation build() {
            return new AGiropayPaymentInformation(name, countryCode, experienceContext);
        }
    }
}

...
/**
 * InvalidGooglePayMerchantIdEnum to be used.
 */
public enum InvalidGooglePayMerchantIdEnum {
    ...
    private static TreeMap<String, InvalidGooglePayMerchantIdEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static InvalidGooglePayMerchantIdEnum constructFromString(String toConvert) throws IOException {
        InvalidGooglePayMerchantIdEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static InvalidGooglePayMerchantIdEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of InvalidGooglePayMerchantIdEnum values to list of string values.
     * @param toConvert The list of InvalidGooglePayMerchantIdEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<InvalidGooglePayMerchantIdEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (InvalidGooglePayMerchantIdEnum enumValue : toConvert) {

...
/**
 * This is a model class for ACTIONDOESNOTMATCHINTENT type.
 */
public class ACTIONDOESNOTMATCHINTENT {
     ...
     * Default constructor.
     */
    public ACTIONDOESNOTMATCHINTENT() {
    }
    ...
    /**
     * Converts this ACTIONDOESNOTMATCHINTENT into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ACTIONDOESNOTMATCHINTENT [" + "issue=" + issue + ", description=" + description
                + "]";
    }

    /**
     * Builds a new {@link ACTIONDOESNOTMATCHINTENT.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ACTIONDOESNOTMATCHINTENT.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ACTIONDOESNOTMATCHINTENT}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ACTIONDOESNOTMATCHINTENT} object using the set fields.
         * @return {@link ACTIONDOESNOTMATCHINTENT}
         */
        public ACTIONDOESNOTMATCHINTENT build() {
            return new ACTIONDOESNOTMATCHINTENT(issue, description);
        }
    }
}

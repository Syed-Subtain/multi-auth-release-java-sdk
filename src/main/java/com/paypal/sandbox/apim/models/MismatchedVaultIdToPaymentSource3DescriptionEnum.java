...
/**
 * MismatchedVaultIdToPaymentSource3DescriptionEnum to be used.
 */
public enum MismatchedVaultIdToPaymentSource3DescriptionEnum {
    ...
    private static TreeMap<String, MismatchedVaultIdToPaymentSource3DescriptionEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static MismatchedVaultIdToPaymentSource3DescriptionEnum constructFromString(String toConvert) throws IOException {
        MismatchedVaultIdToPaymentSource3DescriptionEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static MismatchedVaultIdToPaymentSource3DescriptionEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of MismatchedVaultIdToPaymentSource3DescriptionEnum values to list of string values.
     * @param toConvert The list of MismatchedVaultIdToPaymentSource3DescriptionEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<MismatchedVaultIdToPaymentSource3DescriptionEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (MismatchedVaultIdToPaymentSource3DescriptionEnum enumValue : toConvert) {

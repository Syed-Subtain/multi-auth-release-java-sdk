...
public class VenmoWalletExperienceContext {
    ...
    private ShippingAddressDeriveLocationEnum shippingPreference;

    /**
     * Default constructor.
     */
    public VenmoWalletExperienceContext() {
        shippingPreference = ShippingAddressDeriveLocationEnum.GET_FROM_FILE;
    }

    /**
     * Initialization constructor.
     * @param  brandName  String value for brandName.
     * @param  shippingPreference  ShippingAddressDeriveLocationEnum value for shippingPreference.
     */
    public VenmoWalletExperienceContext(
            String brandName,
            ShippingAddressDeriveLocationEnum shippingPreference) {
     ...
     * @return Returns the ShippingAddressDeriveLocationEnum
     */
    @JsonGetter("shipping_preference")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ShippingAddressDeriveLocationEnum getShippingPreference() {
     ...
     * The location from which the shipping address is derived.
     * @param shippingPreference Value for ShippingAddressDeriveLocationEnum
     */
    @JsonSetter("shipping_preference")
    public void setShippingPreference(ShippingAddressDeriveLocationEnum shippingPreference) {
        this.shippingPreference = shippingPreference;
    }
    ...
    public static class Builder {
        private String brandName;
        private ShippingAddressDeriveLocationEnum shippingPreference =
                ShippingAddressDeriveLocationEnum.GET_FROM_FILE;
        ...
        /**
         * Setter for shippingPreference.
         * @param  shippingPreference  ShippingAddressDeriveLocationEnum value for
         *         shippingPreference.
         * @return Builder
         */
        public Builder shippingPreference(ShippingAddressDeriveLocationEnum shippingPreference) {
            this.shippingPreference = shippingPreference;
            return this;
        }

...
public class MERCHANTINITIATEDWITHMULTIPLEPURCHASEUNITS {
    ...
    private ErrorMerchantInitiatedMultipleUnitsEnum description;
     ...
     * @param  description  ErrorMerchantInitiatedMultipleUnitsEnum value for description.
     */
    public MERCHANTINITIATEDWITHMULTIPLEPURCHASEUNITS(
            MerchantInitiatedMultiplePurchaseUnitsEnum issue,
            ErrorMerchantInitiatedMultipleUnitsEnum description) {
        this.issue = issue;
     ...
     * @return Returns the ErrorMerchantInitiatedMultipleUnitsEnum
     */
    @JsonGetter("description")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ErrorMerchantInitiatedMultipleUnitsEnum getDescription() {
        return description;
    }

    /**
     * Setter for Description.
     * @param description Value for ErrorMerchantInitiatedMultipleUnitsEnum
     */
    @JsonSetter("description")
    public void setDescription(ErrorMerchantInitiatedMultipleUnitsEnum description) {
        this.description = description;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder description(ErrorMerchantInitiatedMultipleUnitsEnum description) {
            this.description = description;
            return this;
        }

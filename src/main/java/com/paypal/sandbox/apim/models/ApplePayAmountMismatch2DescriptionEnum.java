...
/**
 * ApplePayAmountMismatch2DescriptionEnum to be used.
 */
public enum ApplePayAmountMismatch2DescriptionEnum {
    ...
    private static TreeMap<String, ApplePayAmountMismatch2DescriptionEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ApplePayAmountMismatch2DescriptionEnum constructFromString(String toConvert) throws IOException {
        ApplePayAmountMismatch2DescriptionEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static ApplePayAmountMismatch2DescriptionEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of ApplePayAmountMismatch2DescriptionEnum values to list of string values.
     * @param toConvert The list of ApplePayAmountMismatch2DescriptionEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ApplePayAmountMismatch2DescriptionEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ApplePayAmountMismatch2DescriptionEnum enumValue : toConvert) {

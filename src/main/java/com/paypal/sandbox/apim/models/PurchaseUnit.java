...
public class PurchaseUnit {
    ...
    private OrderShippingDetails shipping;
     ...
     * @param  shipping  OrderShippingDetails value for shipping.
     ...
     * @return Returns the OrderShippingDetails
     */
    @JsonGetter("shipping")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public OrderShippingDetails getShipping() {
        return shipping;
    }
     ...
     * Setter for Shipping.
     * The shipping address and method.
     * @param shipping Value for OrderShippingDetails
     */
    @JsonSetter("shipping")
    public void setShipping(OrderShippingDetails shipping) {
        this.shipping = shipping;
    }

    /**
     * Getter for SupplementaryData.
     * Supplementary data about this payment. Merchants and partners can add Level 2 and 3 data to
     * payments to reduce risk and payment processing costs. For more information about processing
     * payments, see &lt;a
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder shipping(OrderShippingDetails shipping) {
            this.shipping = shipping;
            return this;
        }

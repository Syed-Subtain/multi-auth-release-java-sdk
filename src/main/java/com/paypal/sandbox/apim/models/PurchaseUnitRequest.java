...
public class PurchaseUnitRequest {
     ...
     * amount must be a positive number. The `amount.value` field supports up to 15 digits preceding
     * the decimal. For a list of supported currencies, decimal precision, and maximum charge
     * amount, see the PayPal REST APIs &lt;a
     * href="https://developer.paypal.com/api/rest/reference/currency-codes/"&gt;Currency Codes&lt;/a&gt;.

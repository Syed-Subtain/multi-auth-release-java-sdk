...
/**
 * This is a model class for MyBankPaymentInformation type.
 */
public class MyBankPaymentInformation {
    private String name;
     ...
     * Default constructor.
     */
    public MyBankPaymentInformation() {
    }
    ...
    /**
     * Converts this MyBankPaymentInformation into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MyBankPaymentInformation [" + "name=" + name + ", countryCode=" + countryCode
                + ", experienceContext=" + experienceContext + "]";
    }

    /**
     * Builds a new {@link MyBankPaymentInformation.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MyBankPaymentInformation.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link MyBankPaymentInformation}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link MyBankPaymentInformation} object using the set fields.
         * @return {@link MyBankPaymentInformation}
         */
        public MyBankPaymentInformation build() {
            return new MyBankPaymentInformation(name, countryCode, experienceContext);
        }
    }
}

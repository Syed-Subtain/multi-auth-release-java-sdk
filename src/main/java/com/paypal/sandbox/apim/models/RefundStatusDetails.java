...
public class RefundStatusDetails {
    private RefundStatusDetailsReasonEnum reason;
     ...
     * @param  reason  RefundStatusDetailsReasonEnum value for reason.
     */
    public RefundStatusDetails(
            RefundStatusDetailsReasonEnum reason) {
        this.reason = reason;
    }
     ...
     * @return Returns the RefundStatusDetailsReasonEnum
     */
    @JsonGetter("reason")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public RefundStatusDetailsReasonEnum getReason() {
        return reason;
    }
     ...
     * Setter for Reason.
     * The reason why the refund has the `PENDING` or `FAILED` status.
     * @param reason Value for RefundStatusDetailsReasonEnum
     */
    @JsonSetter("reason")
    public void setReason(RefundStatusDetailsReasonEnum reason) {
        this.reason = reason;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder reason(RefundStatusDetailsReasonEnum reason) {
            this.reason = reason;
            return this;
        }

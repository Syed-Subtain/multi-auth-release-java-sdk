...
/**
 * PaymentSourceMismatch1DescriptionEnum to be used.
 */
public enum PaymentSourceMismatch1DescriptionEnum {
    ...
    private static TreeMap<String, PaymentSourceMismatch1DescriptionEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static PaymentSourceMismatch1DescriptionEnum constructFromString(String toConvert) throws IOException {
        PaymentSourceMismatch1DescriptionEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static PaymentSourceMismatch1DescriptionEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of PaymentSourceMismatch1DescriptionEnum values to list of string values.
     * @param toConvert The list of PaymentSourceMismatch1DescriptionEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<PaymentSourceMismatch1DescriptionEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (PaymentSourceMismatch1DescriptionEnum enumValue : toConvert) {

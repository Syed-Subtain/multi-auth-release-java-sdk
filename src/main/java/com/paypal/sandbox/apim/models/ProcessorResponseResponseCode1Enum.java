...
/**
 * ProcessorResponseResponseCode1Enum to be used.
 */
public enum ProcessorResponseResponseCode1Enum {
    ENUM_0000,
    ...
    private static TreeMap<String, ProcessorResponseResponseCode1Enum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ProcessorResponseResponseCode1Enum constructFromString(String toConvert) throws IOException {
        ProcessorResponseResponseCode1Enum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static ProcessorResponseResponseCode1Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of ProcessorResponseResponseCode1Enum values to list of string values.
     * @param toConvert The list of ProcessorResponseResponseCode1Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ProcessorResponseResponseCode1Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ProcessorResponseResponseCode1Enum enumValue : toConvert) {

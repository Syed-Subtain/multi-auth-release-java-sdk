...
public class PaymentSource {
    ...
    public String toString() {
        return "PaymentSource [" + "card=" + card + ", paypal=" + paypal + ", bancontact="
    ...
    public static class Builder {
        ...
        public PaymentSource build() {
            return new PaymentSource(card, paypal, bancontact, blik, eps, giropay, ideal, mybank,
                    p24, sofort, trustly, venmo);
        }
    }
}

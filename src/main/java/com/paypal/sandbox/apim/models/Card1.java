...
/**
 * This is a model class for Card1 type.
 */
public class Card1 {
    private String id;
    private String name;
    ...
    /**
     * Converts this Card1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Card1 [" + "id=" + id + ", name=" + name + ", number=" + number + ", expiry="
    ...
    /**
     * Builds a new {@link Card1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Card1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Card1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Card1} object using the set fields.
         * @return {@link Card1}
         */
        public Card1 build() {
            return new Card1(id, name, number, expiry, securityCode, lastDigits, cardType, type,

...
public class MISSINGPAYMENTPARAMETER {
    ...
    private ReqParamCustPresentInitiatorMerchDescEnum description;
     ...
     * @param  description  ReqParamCustPresentInitiatorMerchDescEnum value for description.
     */
    public MISSINGPAYMENTPARAMETER(
            RequiredParamForCustInitiatedPaymentEnum issue,
            ReqParamCustPresentInitiatorMerchDescEnum description) {
        this.issue = issue;
     ...
     * @return Returns the ReqParamCustPresentInitiatorMerchDescEnum
     */
    @JsonGetter("description")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ReqParamCustPresentInitiatorMerchDescEnum getDescription() {
        return description;
    }

    /**
     * Setter for Description.
     * @param description Value for ReqParamCustPresentInitiatorMerchDescEnum
     */
    @JsonSetter("description")
    public void setDescription(ReqParamCustPresentInitiatorMerchDescEnum description) {
        this.description = description;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder description(ReqParamCustPresentInitiatorMerchDescEnum description) {
            this.description = description;
            return this;
        }

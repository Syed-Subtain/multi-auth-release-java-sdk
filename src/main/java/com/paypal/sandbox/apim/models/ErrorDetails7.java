...
/**
 * This is a model class for ErrorDetails7 type.
 */
public class ErrorDetails7 {
    ...
    /**
     * Converts this ErrorDetails7 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ErrorDetails7 [" + "issue=" + issue + ", field=" + field + ", value=" + value
                + ", location=" + location + ", description=" + description + "]";
    }

    /**
     * Builds a new {@link ErrorDetails7.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ErrorDetails7.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ErrorDetails7}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ErrorDetails7} object using the set fields.
         * @return {@link ErrorDetails7}
         */
        public ErrorDetails7 build() {
            return new ErrorDetails7(issue, field, value, location, description);
        }
    }
}

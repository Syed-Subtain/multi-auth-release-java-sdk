...
public class M422Error {
     ...
     * @param  name  Error422NameEnum value for name.
     * @param  message  Error422MessageEnum value for message.
     ...
     */
    public M422Error(
            Error422NameEnum name,
            Error422MessageEnum message,
     ...
     */
    @JsonSetter("name")
    public void setName(Error422NameEnum name) {
        this.name = name;
    }
    ...
    @JsonGetter("message")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Error422MessageEnum getMessage() {
        return message;
    }

    /**
     * Setter for Message.
     * @param message Value for Error422MessageEnum
     */
    @JsonSetter("message")
    public void setMessage(Error422MessageEnum message) {
        this.message = message;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder name(Error422NameEnum name) {
            this.name = name;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder message(Error422MessageEnum message) {
            this.message = message;
            return this;
        }

...
public class PortablePostalAddressMediumGrained {
     ...
     * @param  addressDetails  AddressDetails value for addressDetails.
     */
    public PortablePostalAddressMediumGrained(
            String countryCode,
            String addressLine1,
     ...
     * The third line of the address, if needed. Examples include a street complement for Brazil,
     ...
     * The neighborhood, ward, or district. This is smaller than `admin_area_level_3` or
     * `sub_locality`. Value is:&lt;ul&gt;&lt;li&gt;The postal sorting code that is used in Guernsey and many
     * French territories, such as French Guiana.&lt;/li&gt;&lt;li&gt;The fine-grained administrative levels in
     * China.&lt;/li&gt;&lt;/ul&gt;
     * @return Returns the String
     */
     ...
     * neighborhood.&lt;/li&gt;&lt;li&gt;India. Sub-locality or district. Street name information isn't always
     * available, but a sub-locality or district can be a very small area.&lt;/li&gt;&lt;/ul&gt;
     * @return Returns the String
     */
     ...
     * The non-portable additional address details include fine-grain address information for
     * Compliance, Risk, and other scenarios. This isn't portable with common third-party and open
     * source applications. This can include data that is redundant with core fields. For example,
     ...
     * `address_portable.address_line_1` is usually a combination of
     * `address_details.street_number`, `street_name`, and `street_type`.
     * @param addressDetails Value for AddressDetails
     */
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder addressDetails(AddressDetails addressDetails) {
            this.addressDetails = addressDetails;
            return this;
        }

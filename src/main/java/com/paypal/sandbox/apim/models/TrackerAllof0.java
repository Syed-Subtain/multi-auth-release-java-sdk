...
/**
 * This is a model class for TrackerAllof0 type.
 */
public class TrackerAllof0 {
    private String id;
    ...
    /**
     * Converts this TrackerAllof0 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TrackerAllof0 [" + "id=" + id + ", status=" + status + ", items=" + items
                + ", links=" + links + "]";
    }

    /**
     * Builds a new {@link TrackerAllof0.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TrackerAllof0.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TrackerAllof0}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link TrackerAllof0} object using the set fields.
         * @return {@link TrackerAllof0}
         */
        public TrackerAllof0 build() {
            return new TrackerAllof0(id, status, items, links);
        }
    }
}

...
/**
 * PaymentSourceMismatchDescriptionEnum to be used.
 */
public enum PaymentSourceMismatchDescriptionEnum {
    ...
    private static TreeMap<String, PaymentSourceMismatchDescriptionEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static PaymentSourceMismatchDescriptionEnum constructFromString(String toConvert) throws IOException {
        PaymentSourceMismatchDescriptionEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static PaymentSourceMismatchDescriptionEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of PaymentSourceMismatchDescriptionEnum values to list of string values.
     * @param toConvert The list of PaymentSourceMismatchDescriptionEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<PaymentSourceMismatchDescriptionEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (PaymentSourceMismatchDescriptionEnum enumValue : toConvert) {

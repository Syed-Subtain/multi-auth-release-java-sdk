...
/**
 * This is a model class for ErrorDetails9 type.
 */
public class ErrorDetails9 {
    ...
    /**
     * Converts this ErrorDetails9 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ErrorDetails9 [" + "issue=" + issue + ", field=" + field + ", value=" + value
                + ", location=" + location + ", description=" + description + "]";
    }

    /**
     * Builds a new {@link ErrorDetails9.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ErrorDetails9.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ErrorDetails9}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ErrorDetails9} object using the set fields.
         * @return {@link ErrorDetails9}
         */
        public ErrorDetails9 build() {
            return new ErrorDetails9(issue, field, value, location, description);
        }
    }
}

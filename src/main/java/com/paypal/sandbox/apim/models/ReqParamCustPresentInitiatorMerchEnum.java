...
/**
 * ReqParamCustPresentInitiatorMerchEnum to be used.
 */
public enum ReqParamCustPresentInitiatorMerchEnum {
    ...
    private static TreeMap<String, ReqParamCustPresentInitiatorMerchEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ReqParamCustPresentInitiatorMerchEnum constructFromString(String toConvert) throws IOException {
        ReqParamCustPresentInitiatorMerchEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static ReqParamCustPresentInitiatorMerchEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of ReqParamCustPresentInitiatorMerchEnum values to list of string values.
     * @param toConvert The list of ReqParamCustPresentInitiatorMerchEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ReqParamCustPresentInitiatorMerchEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ReqParamCustPresentInitiatorMerchEnum enumValue : toConvert) {

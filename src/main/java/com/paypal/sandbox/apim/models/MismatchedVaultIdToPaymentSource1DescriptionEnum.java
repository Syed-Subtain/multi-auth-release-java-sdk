...
/**
 * MismatchedVaultIdToPaymentSource1DescriptionEnum to be used.
 */
public enum MismatchedVaultIdToPaymentSource1DescriptionEnum {
    ...
    private static TreeMap<String, MismatchedVaultIdToPaymentSource1DescriptionEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static MismatchedVaultIdToPaymentSource1DescriptionEnum constructFromString(String toConvert) throws IOException {
        MismatchedVaultIdToPaymentSource1DescriptionEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static MismatchedVaultIdToPaymentSource1DescriptionEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of MismatchedVaultIdToPaymentSource1DescriptionEnum values to list of string values.
     * @param toConvert The list of MismatchedVaultIdToPaymentSource1DescriptionEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<MismatchedVaultIdToPaymentSource1DescriptionEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (MismatchedVaultIdToPaymentSource1DescriptionEnum enumValue : toConvert) {

...
/**
 * This is a model class for Capture1 type.
 */
public class Capture1 {
    ...
    /**
     * Converts this Capture1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Capture1 [" + "status=" + status + ", statusDetails=" + statusDetails + ", id=" + id
    ...
    /**
     * Builds a new {@link Capture1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Capture1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Capture1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Capture1} object using the set fields.
         * @return {@link Capture1}
         */
        public Capture1 build() {
            return new Capture1(status, statusDetails, id, amount, invoiceId, customId,

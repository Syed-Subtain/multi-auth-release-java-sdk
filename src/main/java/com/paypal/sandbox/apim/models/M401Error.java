...
/**
 * This is a model class for M401Error type.
 */
public class M401Error {
     ...
     * @param  name  Error401NameEnum value for name.
     * @param  message  Error401MessageEnum value for message.
     ...
     */
    public M401Error(
            Error401NameEnum name,
            Error401MessageEnum message,
     ...
     */
    @JsonSetter("name")
    public void setName(Error401NameEnum name) {
        this.name = name;
    }
    ...
    @JsonGetter("message")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Error401MessageEnum getMessage() {
        return message;
    }

    /**
     * Setter for Message.
     * @param message Value for Error401MessageEnum
     */
    @JsonSetter("message")
    public void setMessage(Error401MessageEnum message) {
        this.message = message;
    }
    ...
    /**
     * Converts this M401Error into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M401Error [" + "name=" + name + ", message=" + message + ", issues=" + issues
                + ", debugId=" + debugId + ", informationLink=" + informationLink + "]";
    }

    /**
     * Builds a new {@link M401Error.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M401Error.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M401Error}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder name(Error401NameEnum name) {
            this.name = name;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder message(Error401MessageEnum message) {
            this.message = message;
            return this;
        }
        ...
        /**
         * Builds a new {@link M401Error} object using the set fields.
         * @return {@link M401Error}
         */
        public M401Error build() {
            return new M401Error(name, message, issues, debugId, informationLink);
        }
    }
}

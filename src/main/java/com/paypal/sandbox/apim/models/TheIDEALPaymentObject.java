...
/**
 * This is a model class for TheIDEALPaymentObject type.
 */
public class TheIDEALPaymentObject {
    private String name;
    ...
    /**
     * Converts this TheIDEALPaymentObject into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TheIDEALPaymentObject [" + "name=" + name + ", countryCode=" + countryCode
                + ", bic=" + bic + ", ibanLastChars=" + ibanLastChars + ", attributes=" + attributes
                + "]";
    }

    /**
     * Builds a new {@link TheIDEALPaymentObject.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TheIDEALPaymentObject.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TheIDEALPaymentObject}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link TheIDEALPaymentObject} object using the set fields.
         * @return {@link TheIDEALPaymentObject}
         */
        public TheIDEALPaymentObject build() {
            return new TheIDEALPaymentObject(name, countryCode, bic, ibanLastChars, attributes);
        }
    }
}

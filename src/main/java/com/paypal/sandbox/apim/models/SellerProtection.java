...
public class SellerProtection {
    ...
    private List<SellerProtectionDisputeCategoriesItemsEnum> disputeCategories;
     ...
     * @param  disputeCategories  List of SellerProtectionDisputeCategoriesItemsEnum value for
     *         disputeCategories.
     */
    public SellerProtection(
            SellerProtectionStatusEnum status,
            List<SellerProtectionDisputeCategoriesItemsEnum> disputeCategories) {
        this.status = status;
     ...
     * @return Returns the List of SellerProtectionDisputeCategoriesItemsEnum
     */
    @JsonGetter("dispute_categories")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<SellerProtectionDisputeCategoriesItemsEnum> getDisputeCategories() {
     ...
     * An array of conditions that are covered for the transaction.
     * @param disputeCategories Value for List of SellerProtectionDisputeCategoriesItemsEnum
     */
    @JsonSetter("dispute_categories")
    public void setDisputeCategories(List<SellerProtectionDisputeCategoriesItemsEnum> disputeCategories) {
        this.disputeCategories = disputeCategories;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder disputeCategories(
                List<SellerProtectionDisputeCategoriesItemsEnum> disputeCategories) {
            this.disputeCategories = disputeCategories;
            return this;
        }

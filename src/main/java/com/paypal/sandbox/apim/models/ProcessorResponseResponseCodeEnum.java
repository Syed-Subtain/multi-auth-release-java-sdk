...
/**
 * ProcessorResponseResponseCodeEnum to be used.
 */
public enum ProcessorResponseResponseCodeEnum {
    ENUM_0000,
    ...
    private static TreeMap<String, ProcessorResponseResponseCodeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ProcessorResponseResponseCodeEnum constructFromString(String toConvert) throws IOException {
        ProcessorResponseResponseCodeEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static ProcessorResponseResponseCodeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of ProcessorResponseResponseCodeEnum values to list of string values.
     * @param toConvert The list of ProcessorResponseResponseCodeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ProcessorResponseResponseCodeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ProcessorResponseResponseCodeEnum enumValue : toConvert) {

...
public class RefundRequest {
    ...
    private AdditionalPaymentInstruction paymentInstruction;
     ...
     * @param  paymentInstruction  AdditionalPaymentInstruction value for paymentInstruction.
     */
    public RefundRequest(
            Money amount,
            String customId,
            String invoiceId,
            String noteToPayer,
            AdditionalPaymentInstruction paymentInstruction) {
        this.amount = amount;
     ...
     * amount is not specified, an amount equal to &lt;code&gt;captured amount - previous refunds&lt;/code&gt;
     * is refunded. The amount must be a positive number and in the same currency as the one in
     * which the payment was captured.
     ...
     * use this capability.
     * @return Returns the AdditionalPaymentInstruction
     */
    @JsonGetter("payment_instruction")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public AdditionalPaymentInstruction getPaymentInstruction() {
     ...
     * Marketplaces and Platforms capability. Please speak to your account manager if you want to
     * use this capability.
     * @param paymentInstruction Value for AdditionalPaymentInstruction
     */
    @JsonSetter("payment_instruction")
    public void setPaymentInstruction(AdditionalPaymentInstruction paymentInstruction) {
        this.paymentInstruction = paymentInstruction;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder paymentInstruction(AdditionalPaymentInstruction paymentInstruction) {
            this.paymentInstruction = paymentInstruction;
            return this;
        }

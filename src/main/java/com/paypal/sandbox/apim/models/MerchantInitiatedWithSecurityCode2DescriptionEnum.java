...
/**
 * MerchantInitiatedWithSecurityCode2DescriptionEnum to be used.
 */
public enum MerchantInitiatedWithSecurityCode2DescriptionEnum {
    ...
    private static TreeMap<String, MerchantInitiatedWithSecurityCode2DescriptionEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static MerchantInitiatedWithSecurityCode2DescriptionEnum constructFromString(String toConvert) throws IOException {
        MerchantInitiatedWithSecurityCode2DescriptionEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static MerchantInitiatedWithSecurityCode2DescriptionEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of MerchantInitiatedWithSecurityCode2DescriptionEnum values to list of string values.
     * @param toConvert The list of MerchantInitiatedWithSecurityCode2DescriptionEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<MerchantInitiatedWithSecurityCode2DescriptionEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (MerchantInitiatedWithSecurityCode2DescriptionEnum enumValue : toConvert) {

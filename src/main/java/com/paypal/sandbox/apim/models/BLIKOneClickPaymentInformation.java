...
/**
 * This is a model class for BLIKOneClickPaymentInformation type.
 */
public class BLIKOneClickPaymentInformation {
     ...
     * Default constructor.
     */
    public BLIKOneClickPaymentInformation() {
    }
    ...
    /**
     * Converts this BLIKOneClickPaymentInformation into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BLIKOneClickPaymentInformation [" + "consumerReference=" + consumerReference
                + ", authCode=" + authCode + ", aliasLabel=" + aliasLabel + ", aliasKey=" + aliasKey
                + "]";
    }

    /**
     * Builds a new {@link BLIKOneClickPaymentInformation.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BLIKOneClickPaymentInformation.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BLIKOneClickPaymentInformation}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BLIKOneClickPaymentInformation} object using the set fields.
         * @return {@link BLIKOneClickPaymentInformation}
         */
        public BLIKOneClickPaymentInformation build() {
            return new BLIKOneClickPaymentInformation(consumerReference, authCode, aliasLabel,
                    aliasKey);
        }
    }
}

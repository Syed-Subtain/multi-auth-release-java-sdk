...
public class LinkDescription {
    private String href;
    private String rel;
    private LinkDescriptionMethodEnum method;
     ...
     * @param  method  LinkDescriptionMethodEnum value for method.
     */
    public LinkDescription(
            String href,
            String rel,
            LinkDescriptionMethodEnum method) {
        this.href = href;
        this.rel = rel;
        this.method = method;
    }
     ...
     * @return Returns the LinkDescriptionMethodEnum
     */
    @JsonGetter("method")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public LinkDescriptionMethodEnum getMethod() {
        return method;
    }
     ...
     * Setter for Method.
     * The HTTP method required to make the related call.
     * @param method Value for LinkDescriptionMethodEnum
     */
    @JsonSetter("method")
    public void setMethod(LinkDescriptionMethodEnum method) {
        this.method = method;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder method(LinkDescriptionMethodEnum method) {
            this.method = method;
            return this;
        }

...
public class Level2CardProcessingData {
    ...
    /**
     * Getter for TaxTotal.
     * Use this field to break down the amount of tax included in the total purchase amount. The
     * value provided here will not add to the total purchase amount. The value can't be negative,
     * and in most cases, it must be greater than zero in order to qualify for lower interchange
     * rates. Value, by country, is: UK. A county. US. A state. Canada. A province. Japan. A

...
/**
 * This is a model class for ExperienceContext1 type.
 */
public class ExperienceContext1 {
    ...
    /**
     * Converts this ExperienceContext1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ExperienceContext1 [" + "brandName=" + brandName + ", locale=" + locale
                + ", returnUrl=" + returnUrl + ", cancelUrl=" + cancelUrl + ", shippingPreference="
                + shippingPreference + ", vaultInstruction=" + vaultInstruction + "]";
    }

    /**
     * Builds a new {@link ExperienceContext1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ExperienceContext1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ExperienceContext1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ExperienceContext1} object using the set fields.
         * @return {@link ExperienceContext1}
         */
        public ExperienceContext1 build() {
            return new ExperienceContext1(brandName, locale, returnUrl, cancelUrl,

...
public class AuthenticationResponse {
    private LiabilityShiftEnum liabilityShift;
     ...
     * @param  liabilityShift  LiabilityShiftEnum value for liabilityShift.
     ...
     */
    public AuthenticationResponse(
            LiabilityShiftEnum liabilityShift,
     ...
     * @return Returns the LiabilityShiftEnum
     */
    @JsonGetter("liability_shift")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public LiabilityShiftEnum getLiabilityShift() {
     ...
     * Liability shift indicator. The outcome of the issuer's authentication.
     * @param liabilityShift Value for LiabilityShiftEnum
     */
    @JsonSetter("liability_shift")
    public void setLiabilityShift(LiabilityShiftEnum liabilityShift) {
        this.liabilityShift = liabilityShift;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder liabilityShift(LiabilityShiftEnum liabilityShift) {
            this.liabilityShift = liabilityShift;
            return this;
        }

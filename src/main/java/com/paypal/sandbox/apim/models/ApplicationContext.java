...
public class ApplicationContext {
    ...
    private OrderApplicationContextLandingPageEnum landingPage;
    private OrderApplicationContextShippingPreferenceEnum shippingPreference;
    private OrderApplicationContextUserActionEnum userAction;
    ...
    public ApplicationContext() {
        landingPage = OrderApplicationContextLandingPageEnum.NO_PREFERENCE;
        shippingPreference = OrderApplicationContextShippingPreferenceEnum.GET_FROM_FILE;
        userAction = OrderApplicationContextUserActionEnum.CONTINUE;
    }
     ...
     * @param  landingPage  OrderApplicationContextLandingPageEnum value for landingPage.
     * @param  shippingPreference  OrderApplicationContextShippingPreferenceEnum value for
     *         shippingPreference.
     * @param  userAction  OrderApplicationContextUserActionEnum value for userAction.
    ...
    public ApplicationContext(
            String brandName,
            String locale,
            OrderApplicationContextLandingPageEnum landingPage,
            OrderApplicationContextShippingPreferenceEnum shippingPreference,
            OrderApplicationContextUserActionEnum userAction,
     ...
     * `experience_context` object instead of the `application_context` object.
     * @return Returns the OrderApplicationContextLandingPageEnum
     */
    @JsonGetter("landing_page")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public OrderApplicationContextLandingPageEnum getLandingPage() {
        return landingPage;
    }
     ...
     * `payment_source.paypal.experience_context.landing_page`). Please specify this field in the
     * `experience_context` object instead of the `application_context` object.
     * @param landingPage Value for OrderApplicationContextLandingPageEnum
     */
    @JsonSetter("landing_page")
    public void setLandingPage(OrderApplicationContextLandingPageEnum landingPage) {
        this.landingPage = landingPage;
    }
     ...
     * @return Returns the OrderApplicationContextShippingPreferenceEnum
     */
    @JsonGetter("shipping_preference")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public OrderApplicationContextShippingPreferenceEnum getShippingPreference() {
     ...
     * `payment_source.paypal.experience_context.shipping_preference`). Please specify this field in
     * the `experience_context` object instead of the `application_context` object.
     * @param shippingPreference Value for OrderApplicationContextShippingPreferenceEnum
     */
    @JsonSetter("shipping_preference")
    public void setShippingPreference(OrderApplicationContextShippingPreferenceEnum shippingPreference) {
        this.shippingPreference = shippingPreference;
    }
     ...
     * `experience_context` object instead of the `application_context` object.
     * @return Returns the OrderApplicationContextUserActionEnum
     */
    @JsonGetter("user_action")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public OrderApplicationContextUserActionEnum getUserAction() {
        return userAction;
    }
     ...
     * `payment_source.paypal.experience_context.user_action`). Please specify this field in the
     * `experience_context` object instead of the `application_context` object.
     * @param userAction Value for OrderApplicationContextUserActionEnum
     */
    @JsonSetter("user_action")
    public void setUserAction(OrderApplicationContextUserActionEnum userAction) {
        this.userAction = userAction;
    }
     ...
     * present in the request.&lt;/li&gt;&lt;/ul&gt;. The fields in `stored_payment_source` are now available in
     * the `stored_credential` object under the `payment_source` which supports them (eg.
    ...
    public static class Builder {
        ...
        private String locale;
        private OrderApplicationContextLandingPageEnum landingPage =
                OrderApplicationContextLandingPageEnum.NO_PREFERENCE;
        private OrderApplicationContextShippingPreferenceEnum shippingPreference =
                OrderApplicationContextShippingPreferenceEnum.GET_FROM_FILE;
        private OrderApplicationContextUserActionEnum userAction =
                OrderApplicationContextUserActionEnum.CONTINUE;
        private PaymentMethod paymentMethod;
        private String returnUrl;
        private String cancelUrl;
        private StoredPaymentSource storedPaymentSource;
         ...
         * @return Builder
         */
        public Builder landingPage(OrderApplicationContextLandingPageEnum landingPage) {
            this.landingPage = landingPage;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder userAction(OrderApplicationContextUserActionEnum userAction) {
            this.userAction = userAction;
            return this;
        }

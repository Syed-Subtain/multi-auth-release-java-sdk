...
/**
 * This is a model class for RefundAllof1 type.
 */
public class RefundAllof1 {
    private String id;
    ...
    /**
     * Converts this RefundAllof1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RefundAllof1 [" + "id=" + id + ", amount=" + amount + ", invoiceId=" + invoiceId
                + ", customId=" + customId + ", acquirerReferenceNumber=" + acquirerReferenceNumber
                + ", noteToPayer=" + noteToPayer + ", sellerPayableBreakdown="
                + sellerPayableBreakdown + ", payer=" + payer + ", links=" + links + "]";
    }

    /**
     * Builds a new {@link RefundAllof1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RefundAllof1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RefundAllof1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RefundAllof1} object using the set fields.
         * @return {@link RefundAllof1}
         */
        public RefundAllof1 build() {
            return new RefundAllof1(id, amount, invoiceId, customId, acquirerReferenceNumber,
                    noteToPayer, sellerPayableBreakdown, payer, links);
        }
    }
}

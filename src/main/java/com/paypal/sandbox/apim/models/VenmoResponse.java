...
/**
 * This is a model class for VenmoResponse type.
 */
public class VenmoResponse {
    ...
    /**
     * Converts this VenmoResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "VenmoResponse [" + "description=" + description + ", shipping=" + shipping
                ...
                + birthDate + ", taxInfo=" + taxInfo + ", address=" + address + ", userName="
                + userName + "]";
    }

    /**
     * Builds a new {@link VenmoResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link VenmoResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link VenmoResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link VenmoResponse} object using the set fields.
         * @return {@link VenmoResponse}
         */
        public VenmoResponse build() {
            return new VenmoResponse(description, shipping, permitMultiplePaymentTokens, usageType,
                    customerType, emailAddress, payerId, name, phone, birthDate, taxInfo, address,
                    userName);
        }
    }
}

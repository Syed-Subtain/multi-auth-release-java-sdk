...
public class PayPalWalletResponse {
     ...
     * format](https://www.itu.int/rec/T-REC-E.164/en). Available only when you enable the **Contact
     * Telephone Number** option in the &lt;a
     * href="https://www.paypal.com/cgi-bin/customerprofileweb?cmd=_profile-website-payments"&gt;**Profile
     * &amp; Settings**&lt;/a&gt; for the merchant's PayPal account. Supports only the `national_number`
     * property.
    ...
    public String toString() {
        return "PayPalWalletResponse [" + "emailAddress=" + emailAddress + ", accountId="
                + accountId + ", name=" + name + ", phoneType=" + phoneType + ", phoneNumber="
                + phoneNumber + ", birthDate=" + birthDate + ", taxInfo=" + taxInfo + ", address="
    ...
    public static class Builder {
        ...
        public PayPalWalletResponse build() {
            return new PayPalWalletResponse(emailAddress, accountId, name, phoneType, phoneNumber,
                    birthDate, taxInfo, address, attributes);
        }
    }
}

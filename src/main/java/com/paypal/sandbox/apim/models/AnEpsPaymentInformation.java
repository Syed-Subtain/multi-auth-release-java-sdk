...
/**
 * This is a model class for AnEpsPaymentInformation type.
 */
public class AnEpsPaymentInformation {
    private String name;
     ...
     * Default constructor.
     */
    public AnEpsPaymentInformation() {
    }
    ...
    /**
     * Converts this AnEpsPaymentInformation into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AnEpsPaymentInformation [" + "name=" + name + ", countryCode=" + countryCode
                + ", experienceContext=" + experienceContext + "]";
    }

    /**
     * Builds a new {@link AnEpsPaymentInformation.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AnEpsPaymentInformation.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AnEpsPaymentInformation}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link AnEpsPaymentInformation} object using the set fields.
         * @return {@link AnEpsPaymentInformation}
         */
        public AnEpsPaymentInformation build() {
            return new AnEpsPaymentInformation(name, countryCode, experienceContext);
        }
    }
}

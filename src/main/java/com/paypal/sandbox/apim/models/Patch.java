...
public class Patch {
     ...
     * @param  op  PatchOpEnum value for op.
     ...
     * Getter for Op.
     * The operation.
     * @return Returns the PatchOpEnum
     */
    @JsonGetter("op")
    public PatchOpEnum getOp() {
        return op;
    }
     ...
     * Setter for Op.
     * The operation.
     * @param op Value for PatchOpEnum
     */
    @JsonSetter("op")
    public void setOp(PatchOpEnum op) {
        this.op = op;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder op(PatchOpEnum op) {
            this.op = op;
            return this;
        }

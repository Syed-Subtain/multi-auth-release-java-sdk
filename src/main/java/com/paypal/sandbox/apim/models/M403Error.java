...
/**
 * This is a model class for M403Error type.
 */
public class M403Error {
     ...
     * @param  name  Error403NameEnum value for name.
     * @param  message  Error403MessageEnum value for message.
     ...
     */
    public M403Error(
            Error403NameEnum name,
            Error403MessageEnum message,
     ...
     */
    @JsonSetter("name")
    public void setName(Error403NameEnum name) {
        this.name = name;
    }
    ...
    @JsonGetter("message")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Error403MessageEnum getMessage() {
        return message;
    }

    /**
     * Setter for Message.
     * @param message Value for Error403MessageEnum
     */
    @JsonSetter("message")
    public void setMessage(Error403MessageEnum message) {
        this.message = message;
    }
    ...
    /**
     * Converts this M403Error into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M403Error [" + "name=" + name + ", message=" + message + ", issues=" + issues
                + ", debugId=" + debugId + ", informationLink=" + informationLink + "]";
    }

    /**
     * Builds a new {@link M403Error.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M403Error.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M403Error}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder name(Error403NameEnum name) {
            this.name = name;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder message(Error403MessageEnum message) {
            this.message = message;
            return this;
        }
        ...
        /**
         * Builds a new {@link M403Error} object using the set fields.
         * @return {@link M403Error}
         */
        public M403Error build() {
            return new M403Error(name, message, issues, debugId, informationLink);
        }
    }
}

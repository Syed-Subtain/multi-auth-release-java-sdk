...
/**
 * MerchantInitiatedWithSecurityCode1DescriptionEnum to be used.
 */
public enum MerchantInitiatedWithSecurityCode1DescriptionEnum {
    ...
    private static TreeMap<String, MerchantInitiatedWithSecurityCode1DescriptionEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static MerchantInitiatedWithSecurityCode1DescriptionEnum constructFromString(String toConvert) throws IOException {
        MerchantInitiatedWithSecurityCode1DescriptionEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static MerchantInitiatedWithSecurityCode1DescriptionEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of MerchantInitiatedWithSecurityCode1DescriptionEnum values to list of string values.
     * @param toConvert The list of MerchantInitiatedWithSecurityCode1DescriptionEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<MerchantInitiatedWithSecurityCode1DescriptionEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (MerchantInitiatedWithSecurityCode1DescriptionEnum enumValue : toConvert) {

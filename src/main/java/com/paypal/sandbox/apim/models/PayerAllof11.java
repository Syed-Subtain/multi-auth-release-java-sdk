...
/**
 * This is a model class for PayerAllof11 type.
 */
public class PayerAllof11 {
    ...
    /**
     * Converts this PayerAllof11 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PayerAllof11 [" + "name=" + name + ", phone=" + phone + ", birthDate=" + birthDate
                + ", taxInfo=" + taxInfo + ", address=" + address + "]";
    }

    /**
     * Builds a new {@link PayerAllof11.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PayerAllof11.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PayerAllof11}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PayerAllof11} object using the set fields.
         * @return {@link PayerAllof11}
         */
        public PayerAllof11 build() {
            return new PayerAllof11(name, phone, birthDate, taxInfo, address);
        }
    }
}

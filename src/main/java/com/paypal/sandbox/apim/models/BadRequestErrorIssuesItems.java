...
/**
 * This is a model class for BadRequestErrorIssuesItems type.
 */
public class BadRequestErrorIssuesItems {
     ...
     * Default constructor.
     */
    public BadRequestErrorIssuesItems() {
    }
    ...
    /**
     * Converts this BadRequestErrorIssuesItems into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BadRequestErrorIssuesItems [" + "issue=" + issue + ", description=" + description
                + "]";
    }

    /**
     * Builds a new {@link BadRequestErrorIssuesItems.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BadRequestErrorIssuesItems.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BadRequestErrorIssuesItems}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BadRequestErrorIssuesItems} object using the set fields.
         * @return {@link BadRequestErrorIssuesItems}
         */
        public BadRequestErrorIssuesItems build() {
            return new BadRequestErrorIssuesItems(issue, description);
        }
    }
}

...
public class ShippingOption {
     ...
     * @param  type  ShippingTypeEnum value for type.
     ...
     * @return Returns the ShippingTypeEnum
     */
    @JsonGetter("type")
     ...
     * Setter for Type.
     * The method by which the payer wants to get their items.
     * @param type Value for ShippingTypeEnum
     */
    @JsonSetter("type")
    public void setType(ShippingTypeEnum type) {
        this.type = type;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder type(ShippingTypeEnum type) {
            this.type = type;
            return this;
        }

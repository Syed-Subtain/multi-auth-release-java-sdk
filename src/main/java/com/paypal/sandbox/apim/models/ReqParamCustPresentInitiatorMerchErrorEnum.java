...
/**
 * ReqParamCustPresentInitiatorMerchErrorEnum to be used.
 */
public enum ReqParamCustPresentInitiatorMerchErrorEnum {
    ...
    private static TreeMap<String, ReqParamCustPresentInitiatorMerchErrorEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ReqParamCustPresentInitiatorMerchErrorEnum constructFromString(String toConvert) throws IOException {
        ReqParamCustPresentInitiatorMerchErrorEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static ReqParamCustPresentInitiatorMerchErrorEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of ReqParamCustPresentInitiatorMerchErrorEnum values to list of string values.
     * @param toConvert The list of ReqParamCustPresentInitiatorMerchErrorEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ReqParamCustPresentInitiatorMerchErrorEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ReqParamCustPresentInitiatorMerchErrorEnum enumValue : toConvert) {

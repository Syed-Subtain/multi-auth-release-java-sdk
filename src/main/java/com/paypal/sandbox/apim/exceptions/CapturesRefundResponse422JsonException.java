...
import com.paypal.sandbox.apim.models.ErrorDetails231;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for CapturesRefundResponse422JsonException type.
 */
public class CapturesRefundResponse422JsonException extends ApiException {
    private static final long serialVersionUID = -1436495140459911096L;
    private Error422NameEnum name;
    private Error422MessageEnum message;
    private List<ErrorDetails231> issues;
     ...
     */
    public CapturesRefundResponse422JsonException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails231
     */
    @JsonGetter("issues")
    public List<ErrorDetails231> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails231
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails231> issues) {
        this.issues = issues;
    }

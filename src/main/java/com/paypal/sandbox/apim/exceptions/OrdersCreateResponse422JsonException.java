...
import com.paypal.sandbox.apim.models.ErrorDetails3;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for OrdersCreateResponse422JsonException type.
 */
public class OrdersCreateResponse422JsonException extends ApiException {
    private static final long serialVersionUID = 8703185609796732238L;
     ...
     */
    public OrdersCreateResponse422JsonException(String reason, Context context) {
     ...
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails3> issues) {
        this.issues = issues;
    }

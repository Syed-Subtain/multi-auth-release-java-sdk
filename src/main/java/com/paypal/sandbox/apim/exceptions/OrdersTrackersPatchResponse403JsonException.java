...
import com.paypal.sandbox.apim.models.ErrorDetails28;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for OrdersTrackersPatchResponse403JsonException type.
 */
public class OrdersTrackersPatchResponse403JsonException extends ApiException {
    private static final long serialVersionUID = 7022759442854652572L;
    private Error403NameEnum name;
    private Error403MessageEnum message;
    private List<ErrorDetails28> issues;
     ...
     */
    public OrdersTrackersPatchResponse403JsonException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails28
     */
    @JsonGetter("issues")
    public List<ErrorDetails28> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails28
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails28> issues) {
        this.issues = issues;
    }

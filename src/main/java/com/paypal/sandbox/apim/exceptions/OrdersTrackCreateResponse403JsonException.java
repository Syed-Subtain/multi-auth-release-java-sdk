...
import com.paypal.sandbox.apim.models.ErrorDetails24;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for OrdersTrackCreateResponse403JsonException type.
 */
public class OrdersTrackCreateResponse403JsonException extends ApiException {
    private static final long serialVersionUID = -3326472627765437288L;
    private Error403NameEnum name;
    private Error403MessageEnum message;
    private List<ErrorDetails24> issues;
     ...
     */
    public OrdersTrackCreateResponse403JsonException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails24
     */
    @JsonGetter("issues")
    public List<ErrorDetails24> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails24
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails24> issues) {
        this.issues = issues;
    }

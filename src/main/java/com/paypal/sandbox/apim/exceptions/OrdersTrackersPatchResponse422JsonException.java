...
import com.paypal.sandbox.apim.models.ErrorDetails30;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for OrdersTrackersPatchResponse422JsonException type.
 */
public class OrdersTrackersPatchResponse422JsonException extends ApiException {
    private static final long serialVersionUID = -5571279772746335590L;
    private Error422NameEnum name;
    private Error422MessageEnum message;
    private List<ErrorDetails30> issues;
     ...
     */
    public OrdersTrackersPatchResponse422JsonException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails30
     */
    @JsonGetter("issues")
    public List<ErrorDetails30> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails30
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails30> issues) {
        this.issues = issues;
    }

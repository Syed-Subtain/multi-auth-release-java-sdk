...
import com.paypal.sandbox.apim.models.ErrorDetails20;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for OrdersCaptureResponse403JsonException type.
 */
public class OrdersCaptureResponse403JsonException extends ApiException {
    private static final long serialVersionUID = 1434844950058489432L;
    private Error403NameEnum name;
    private Error403MessageEnum message;
    private List<ErrorDetails20> issues;
     ...
     */
    public OrdersCaptureResponse403JsonException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails20
     */
    @JsonGetter("issues")
    public List<ErrorDetails20> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails20
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails20> issues) {
        this.issues = issues;
    }

...
import com.paypal.sandbox.apim.models.ErrorDetails17;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for OrdersAuthorizeResponse422JsonException type.
 */
public class OrdersAuthorizeResponse422JsonException extends ApiException {
    private static final long serialVersionUID = -1858461531317053874L;
    private Error422NameEnum name;
    private Error422MessageEnum message;
    private List<ErrorDetails17> issues;
     ...
     */
    public OrdersAuthorizeResponse422JsonException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails17
     */
    @JsonGetter("issues")
    public List<ErrorDetails17> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails17
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails17> issues) {
        this.issues = issues;
    }

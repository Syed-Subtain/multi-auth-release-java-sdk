...
import com.paypal.sandbox.apim.models.ErrorDetails12;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for OrdersConfirmResponse422JsonException type.
 */
public class OrdersConfirmResponse422JsonException extends ApiException {
    private static final long serialVersionUID = -7532483249373246108L;
     ...
     */
    public OrdersConfirmResponse422JsonException(String reason, Context context) {
     ...
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails12> issues) {
        this.issues = issues;
    }

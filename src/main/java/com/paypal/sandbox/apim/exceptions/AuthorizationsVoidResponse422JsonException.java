...
import com.paypal.sandbox.apim.models.ErrorDetails151;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for AuthorizationsVoidResponse422JsonException type.
 */
public class AuthorizationsVoidResponse422JsonException extends ApiException {
    private static final long serialVersionUID = -1979971467579649592L;
    private Error422NameEnum name;
    private Error422MessageEnum message;
    private List<ErrorDetails151> issues;
     ...
     */
    public AuthorizationsVoidResponse422JsonException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails151
     */
    @JsonGetter("issues")
    public List<ErrorDetails151> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails151
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails151> issues) {
        this.issues = issues;
    }

...
import com.paypal.sandbox.apim.models.ErrorDetails9;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for OrdersPatchResponse422JsonException type.
 */
public class OrdersPatchResponse422JsonException extends ApiException {
    private static final long serialVersionUID = -8151741118913067630L;
    private Error422NameEnum name;
    private Error422MessageEnum message;
    private List<ErrorDetails9> issues;
     ...
     */
    public OrdersPatchResponse422JsonException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails9
     */
    @JsonGetter("issues")
    public List<ErrorDetails9> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails9
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails9> issues) {
        this.issues = issues;
    }

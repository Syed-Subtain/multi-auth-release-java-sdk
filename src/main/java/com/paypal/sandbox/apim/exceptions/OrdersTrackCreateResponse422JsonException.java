...
import com.paypal.sandbox.apim.models.ErrorDetails26;
...
public class OrdersTrackCreateResponse422JsonException extends ApiException {
    private static final long serialVersionUID = 3643587653691135125L;
    private Error422NameEnum name;
    private Error422MessageEnum message;
    private List<ErrorDetails26> issues;
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails26
     */
    @JsonGetter("issues")
    public List<ErrorDetails26> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails26
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails26> issues) {
        this.issues = issues;
    }

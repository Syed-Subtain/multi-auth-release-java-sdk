...
import com.paypal.sandbox.apim.models.ErrorDetails22;
import io.apimatic.coreinterfaces.http.Context;
import java.util.List;

/**
 * This is a model class for OrdersCaptureResponse422JsonException type.
 */
public class OrdersCaptureResponse422JsonException extends ApiException {
    private static final long serialVersionUID = -2771201121182452245L;
    private Error422NameEnum name;
    private Error422MessageEnum message;
    private List<ErrorDetails22> issues;
     ...
     */
    public OrdersCaptureResponse422JsonException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails22
     */
    @JsonGetter("issues")
    public List<ErrorDetails22> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails22
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails22> issues) {
        this.issues = issues;
    }

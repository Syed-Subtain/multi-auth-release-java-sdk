...
public class Oauth2Model {
    ...
    private List<OAuthScopeOauth2Enum> oAuthScopes;

    /**
     * A Constructor for Oauth2Model.
     */
    private Oauth2Model(String oAuthClientId, String oAuthClientSecret, OAuthToken oAuthToken,
    ...
    /**
     * Builds a new {@link Oauth2Model.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link Oauth2Model.Builder} object.
     */
    ...
    public static class Builder {
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oAuthScopes(List<OAuthScopeOauth2Enum> oAuthScopes) {
            this.oAuthScopes = oAuthScopes;
            return this;
        }

        /**
         * Builds the instance of Oauth2Model.
         */
        public Oauth2Model build() {
            return new Oauth2Model(oAuthClientId, oAuthClientSecret, oAuthToken, oAuthScopes);
        }
    }
}
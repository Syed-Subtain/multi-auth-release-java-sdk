 ...
 */
public class Oauth21Manager extends HeaderAuth implements Oauth21Credentials {
     ...
     */
    private Oauth21Model authModel;

    /**
     * Constructor.
     */
    public Oauth21Manager(Oauth21Model authModel) {
    ...
    */
    ...
    /**
     * List of OAuthScopeOauth21Enum value for oAuthScopes.
     * @return oAuthScopes
     */
     ...
     * @param oAuthScopes List of OAuthScopeOauth21Enum value for credentials.
    ...
    /**
     * Converts this Oauth21Manager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Oauth21Manager [" + "oAuthClientId=" + getOAuthClientId() + ", oAuthClientSecret="
    ...
    public CompletableFuture<OAuthToken> fetchTokenAsync(
        ...
        return oAuthApi.requestTokenOauth21Async(
    ...
    public OAuthToken fetchToken(Map<String, Object> additionalParameters)
        ...
        OAuthToken token = oAuthApi.requestTokenOauth21(
            getBasicAuthForClient(),
            stringJoin(getOAuthScopes(), " "),
            aparams);

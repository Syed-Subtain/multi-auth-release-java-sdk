...
import com.paypal.sandbox.apim.exceptions.OrdersAuthorizeResponse400JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersAuthorizeResponse401JsonException;
...
import com.paypal.sandbox.apim.exceptions.OrdersCaptureResponse400JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersCaptureResponse401JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersCaptureResponse403JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersCaptureResponse404JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersCaptureResponse422JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersConfirmResponse400JsonException;
...
import com.paypal.sandbox.apim.exceptions.OrdersCreateResponse400JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersCreateResponse401JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersCreateResponse422JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersGetResponse401JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersGetResponse404JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersPatchResponse400JsonException;
import com.paypal.sandbox.apim.exceptions.OrdersPatchResponse401JsonException;
...
import com.paypal.sandbox.apim.exceptions.OrdersTrackCreateResponse400JsonException;
...
public final class OrdersController extends BaseController {
    ...
    public Order ordersGet(
        ...
        return prepareOrdersGetRequest(id, fields).execute();
    }
    ...
    public CompletableFuture<Order> ordersGetAsync(
            ...
            final String fields) {
        try { 
            return prepareOrdersGetRequest(id, fields).executeAsync(); 
        } catch (Exception e) {  
        ...
        return new ApiCall.Builder<Order, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("401",
                                ...
                                (reason, context) -> new OrdersGetResponse401JsonException(reason, context)))
                        .localErrorCase("404",
                                 ErrorCase.setReason("The specified resource does not exist.",
                                (reason, context) -> new OrdersGetResponse404JsonException(reason, context)))
        ...
        return new ApiCall.Builder<Void, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("400",
                                ...
                                (reason, context) -> new OrdersPatchResponse400JsonException(reason, context)))
                        .localErrorCase("401",
                                 ErrorCase.setReason("Authentication failed due to missing authorization header, or invalid authentication credentials.",
                                (reason, context) -> new OrdersPatchResponse401JsonException(reason, context)))
                        .localErrorCase("404",
                                 ErrorCase.setReason("The specified resource does not exist.",
    ...
    public Order ordersCapture(
        ...
        return prepareOrdersCaptureRequest(id, payPalRequestId, prefer, payPalClientMetadataId,
    ...
    private ApiCall<Order, ApiException> prepareOrdersCaptureRequest(
        ...
        return new ApiCall.Builder<Order, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("400",
                                 ErrorCase.setReason("Request is not well-formed, syntactically incorrect, or violates schema.",
                                (reason, context) -> new OrdersCaptureResponse400JsonException(reason, context)))
                        .localErrorCase("401",
                                 ErrorCase.setReason("Authentication failed due to missing authorization header, or invalid authentication credentials.",
                                (reason, context) -> new OrdersCaptureResponse401JsonException(reason, context)))
                        .localErrorCase("403",
                                 ErrorCase.setReason("The authorized payment failed due to insufficient permissions.",
                                (reason, context) -> new OrdersCaptureResponse403JsonException(reason, context)))
                        .localErrorCase("404",
                                 ErrorCase.setReason("The specified resource does not exist.",
                                (reason, context) -> new OrdersCaptureResponse404JsonException(reason, context)))
                        .localErrorCase("422",
                                 ErrorCase.setReason("The requested action could not be performed, semantically incorrect, or failed business validation.",
                                (reason, context) -> new OrdersCaptureResponse422JsonException(reason, context)))
                        .localErrorCase("500",
    ...
    public Order ordersCreate(
        ...
        return prepareOrdersCreateRequest(payPalRequestId, body, payPalPartnerAttributionId,
    ...
    private ApiCall<Order, ApiException> prepareOrdersCreateRequest(
        ...
        return new ApiCall.Builder<Order, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("400",
                                 ErrorCase.setReason("Request is not well-formed, syntactically incorrect, or violates schema.",
                                (reason, context) -> new OrdersCreateResponse400JsonException(reason, context)))
                        .localErrorCase("401",
                                 ErrorCase.setReason("Authentication failed due to missing authorization header, or invalid authentication credentials.",
                                (reason, context) -> new OrdersCreateResponse401JsonException(reason, context)))
                        .localErrorCase("422",
                                 ErrorCase.setReason("The requested action could not be performed, semantically incorrect, or failed business validation.",
                                (reason, context) -> new OrdersCreateResponse422JsonException(reason, context)))
                        .localErrorCase(ErrorCase.DEFAULT,
                                 ErrorCase.setReason("The default response.",
                                (reason, context) -> new ApiException(reason, context)))
                        .globalErrorCase(GLOBAL_ERROR_CASES))
    ...
    private ApiCall<Order, ApiException> prepareOrdersTrackCreateRequest(
        ...
        return new ApiCall.Builder<Order, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("400",
                                 ErrorCase.setReason("Request is not well-formed, syntactically incorrect, or violates schema.",
                                (reason, context) -> new OrdersTrackCreateResponse400JsonException(reason, context)))
                        .localErrorCase("403",
    ...
    private ApiCall<OrderAuthorizeResponse, ApiException> prepareOrdersAuthorizeRequest(
        ...
        return new ApiCall.Builder<OrderAuthorizeResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("400",
                                 ErrorCase.setReason("Request is not well-formed, syntactically incorrect, or violates schema.",
                                (reason, context) -> new OrdersAuthorizeResponse400JsonException(reason, context)))
                        .localErrorCase("401",
                                 ErrorCase.setReason("Authentication failed due to missing authorization header, or invalid authentication credentials.",
                                (reason, context) -> new OrdersAuthorizeResponse401JsonException(reason, context)))
                        .localErrorCase("403",
                                 ErrorCase.setReason("The authorized payment failed due to insufficient permissions.",
    ...
    private ApiCall<Order, ApiException> prepareOrdersConfirmRequest(
        ...
        return new ApiCall.Builder<Order, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("400",
                                 ErrorCase.setReason("Request is not well-formed, syntactically incorrect, or violates schema.",
                                (reason, context) -> new OrdersConfirmResponse400JsonException(reason, context)))
                        .localErrorCase("403",
                                 ErrorCase.setReason("Authorization failed due to insufficient permissions.",

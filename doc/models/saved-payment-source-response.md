...
| `Status` | [`VaultResponseStatusEnum`](../../doc/models/vault-response-status-enum.md) | Optional | The vault status.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255`, *Pattern*: `^[0-9A-Z_]+$` | VaultResponseStatusEnum getStatus() | setStatus(VaultResponseStatusEnum status) |

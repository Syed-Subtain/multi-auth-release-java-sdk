...
# Orders Patch Response 422 Json Exception

## Structure

`OrdersPatchResponse422JsonException`
...
| `Issues` | [`List<ErrorDetails9>`](../../doc/models/error-details-9.md) | Optional | - | List<ErrorDetails9> getIssues() | setIssues(List<ErrorDetails9> issues) |

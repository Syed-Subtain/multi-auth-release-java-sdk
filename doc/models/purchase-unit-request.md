...
| `Shipping` | [`ShippingDetails`](../../doc/models/shipping-details.md) | Optional | The name and address of the person to whom to ship the items. | ShippingDetails getShipping() | setShipping(ShippingDetails shipping) |
| `SupplementaryData` | [`SupplementaryData`](../../doc/models/supplementary-data.md) | Optional | Contains Supplementary Data. | SupplementaryData getSupplementaryData() | setSupplementaryData(SupplementaryData supplementaryData) |

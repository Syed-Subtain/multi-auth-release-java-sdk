...
# Orders Capture Response 422 Json Exception

## Structure

`OrdersCaptureResponse422JsonException`
...
| `Issues` | [`List<ErrorDetails22>`](../../doc/models/error-details-22.md) | Optional | - | List<ErrorDetails22> getIssues() | setIssues(List<ErrorDetails22> issues) |
